<template>
  <div :class="[
    ...
    <div class="min-w-0">
      ...
      <p class="text-sm max-xs:text-xs" :class="themeStore.isDarkMode ? 'text-gray-200' : 'text-indigo-100'">{{ $t('calculator.subtitle') }}</p>
    </div>
    <div class="flex items-center space-x-2 max-sm:space-x-1 max-xs:space-x-1">
      ...
      <button
        ...
        class="p-2 max-xs:p-1.5 rounded-full hover:bg-opacity-10 hover:bg-white mr-2"
