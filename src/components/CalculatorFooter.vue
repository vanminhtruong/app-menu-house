    ...
    <div class="flex flex-col space-y-2">
      <button 
        ...
        :class="[
          ...
          themeStore.isPureDark
            ? 'bg-neutral-900 text-neutral-300 hover:bg-neutral-800 border-none pd-shadow'
            : themeStore.isDarkMode 
      ...
      <div :class="themeStore.isPureDark ? 'text-neutral-500' : themeStore.isDarkMode ? 'text-gray-400' : 'text-gray-500'" class="text-xs">{{ $t('calculator.footer.updatedOn') }}: {{ currentDate }}</div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-full sm:w-auto">
      <button
        ...
        :class="[
          ...
          canShowDetails 
            ? (themeStore.isPureDark
                ? 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white hover:from-blue-500 hover:to-indigo-600 focus:ring-blue-500 shadow-[0_0_15px_rgba(37,99,235,0.5)] animate-pulse-subtle border border-blue-500'
                : themeStore.isDarkMode
            ...
            : (themeStore.isPureDark
                ? 'bg-neutral-900 text-neutral-400 hover:bg-neutral-800 focus:ring-neutral-600 pd-shadow border-none'
                : themeStore.isDarkMode
      ...
      <button 
        ...
        :class="[
          ...
          themeStore.isPureDark
            ? 'bg-neutral-900 border-none text-neutral-300 hover:bg-neutral-800 focus:ring-neutral-600 pd-shadow'
            : themeStore.isDarkMode 
